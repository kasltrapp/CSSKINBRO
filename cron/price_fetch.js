...
const FN_ONLY = [
  '★ Karambit | Fade', '★ Karambit | Gamma Doppler', '★ Karambit | Doppler',
  '★ Butterfly Knife | Fade', '★ Butterfly Knife | Gamma Doppler', '★ Butterfly Knife | Lore',
  '★ M9 Bayonet | Fade', '★ M9 Bayonet | Gamma Doppler',
  '★ Talon Knife | Fade', '★ Talon Knife | Doppler',
  '★ Kukri Knife | Fade', '★ Kukri Knife | Doppler',
  '★ Shadow Daggers | Gamma Doppler', '★ Stiletto Knife | Doppler', '★ Flip Knife | Gamma Doppler',
  'AWP | Dragon Lore', 'AWP | Gungnir', 'AWP | Lightning Strike',
  'AK-47 | Wild Lotus', 'AK-47 | Gold Arabesque',
  'M4A4 | Howl',
];

// Gloves only come in FT/WW/BS
const GLOVE_BASES = [
  'Driver Gloves | Imperial Plaid', 'Driver Gloves | Racing Green', 'Driver Gloves | Black Tie',
  'Broken Fang Gloves | Unhinged', "Sport Gloves | Pandora's Box", 'Sport Gloves | Vice',
  'Specialist Gloves | Marble Fade', 'Moto Gloves | Spearmint', 'Hand Wraps | Cobalt Skulls',
];
