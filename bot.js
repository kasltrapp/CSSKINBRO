...
async function lookupPrice(query) {
  ...
  const path = `/rest/v1/cs2_prices?market_hash_name=ilike.*${encodeURIComponent(query)}*&zar_real=gt.0&order=sold_7d.desc.nullslast&limit=5&select=market_hash_name,item_group,wear,is_stattrak,is_souvenir,zar_real,zar_steam,change_pct_real,sold_7d`;
